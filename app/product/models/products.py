...
class Product(CharNameModel, TimestampMixin, models.Model):
    ...
    convenience = models.ManyToManyField('product.Convenience', related_name='products')
    type = models.ForeignKey('product.Type', verbose_name=_('Тип построение'), related_name='products', on_delete=models.PROTECT)
